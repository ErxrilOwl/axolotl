  ...
  >
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
      ...
      >
        <button
          @click="handleToggle"
          class="flex items-center justify-center w-10 h-10 text-gray-500 border-gray-200 rounded-lg z-99999 dark:border-gray-800 dark:text-gray-400 lg:h-11 lg:w-11 lg:border cursor-pointer"
          :class="[
            isMobileOpen
...
import SearchBar from '@/components/admin/header/SearchBar.vue'
import HeaderLogo from '@/components/admin/header/HeaderLogo.vue'
import NotificationMenu from '@/components/admin/header/NotificationMenu.vue'
import UserMenu from '@/components/admin/header/UserMenu.vue'
