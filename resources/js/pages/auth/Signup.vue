        ...
        <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
          ...
          <div>
            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5">
              <button type="button" class="inline-flex items-center justify-center gap-2 sm:gap-3 py-3 text-xs sm:text-sm font-normal text-gray-700 transition-colors bg-gray-100 rounded-lg px-3 sm:px-4 hover:bg-gray-200 hover:text-gray-800 dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10 whitespace-nowrap">
            ...
            <div class="mt-5">
              <p class="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                ...
                <Link href="/signin" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Sign In</Link>
              </p>
            </div>
          </div>
        </div>
